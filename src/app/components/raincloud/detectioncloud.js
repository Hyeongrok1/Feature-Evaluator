...
export default function DetectionCloud({ hoveredModel, setHoveredModel }) {
    ...
    useEffect(() => {
        ...
        get_scores().then(function(rawData) {
            ...
            const categories = [
                { id: 'first', key: 'first_detection', label: 'Gpt-4o-mini', color: '#4263EB' },
                { id: 'second', key: 'second_detection', label: 'Gemini-flash', color: '#845EF7' },
                { id: 'third', key: 'third_detection', label: 'Llama', color: '#0B7285' }
            ];
