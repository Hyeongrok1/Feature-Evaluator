...
export default function FuzzCloud({ hoveredModel, setHoveredModel }) {
    ...
    useEffect(() => {
        ...
        get_scores().then(function(rawData) {
            ...
            const categories = [
                { id: 'first', key: 'first_fuzz', label: 'Gpt-4o-mini', color: '#4263EB' },
                { id: 'second', key: 'second_fuzz', label: 'Gemini-flash', color: '#845EF7' },
                { id: 'third', key: 'third_fuzz', label: 'Llama', color: '#0B7285' }
            ];
